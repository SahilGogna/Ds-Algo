...
@RestController
public class CurrencyCalcConfigController {
	...
	@GetMapping("/limits")
	public CurrencyCalculationConfig retreiveLimitsFromConfig() {
		return new CurrencyCalculationConfig(config.getMaximum(), config.getMinimum());
	}

...
public class Methods {
	public static void main(String[] args) {
		...
		Integer n2 = new Integer(20);//integer object 
		
		String st1 = " Hello ";//String object
		String st2 = new String(" World ");//String object
		...
		//method substring()
		System.out.println("The value of sub-string from the char 0 to char 5) is = *" + st3.substring(0, 6) + "*");
		System.out.println("The value of sub-string from the char 5 to the end) is = *" + st3.substring(5) + "*");
